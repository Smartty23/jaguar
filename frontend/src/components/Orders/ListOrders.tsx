            ...
            <CardBox hasTable key={item.id} className={'rounded'}>
              <div className={'flex items-center overflow-hidden'}>
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs text-gray-500'}>GrindChoice</p>
                    <p className={'line-clamp-2'}>{item.grind_choice}</p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs text-gray-500'}>ShippingTracking</p>
                    <p className={'line-clamp-2'}>{item.shipping_tracking}</p>
                  </div>
                </div>
                <ListActionsPopover
                  onDelete={onDelete}
