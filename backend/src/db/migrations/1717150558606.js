module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('payments', 'verified', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('orders', 'shipping_tracking', {
        transaction,
      });

      await queryInterface.removeColumn('orders', 'grind_choice', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('customers', 'taste_preferences', {
        transaction,
      });

      await queryInterface.removeColumn('customers', 'email', { transaction });

      await queryInterface.removeColumn('customers', 'name', { transaction });

      await queryInterface.removeColumn('coffee_blends', 'categoryId', {
        transaction,
      });
